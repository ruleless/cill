#ifndef __CORE_SMARTPOINTER_H__
#define __CORE_SMARTPOINTER_H__
...
class ConstSmartPointer
{
  public:
	...
	// These functions return whether or not the input objects refer to the same object.
	...
	// These functions return not or whether the input objects refer to the same object.
	friend bool operator!=(const ConstSmartPointer<T>& A, const ConstSmartPointer<T>& B)
	{
		return A.obj_ != B.obj_;
	}
	...
	// These functions give an ordering on smart pointers so that they can be placed in sorted containers.
	friend bool operator<(const ConstSmartPointer<T>& A, const ConstSmartPointer<T>& B)
	{
		return A.obj_ < B.obj_;
	}
	...
	// These functions give an ordering on smart pointers so that they can be compared.
	friend bool operator>(const ConstSmartPointer<T>& A, const ConstSmartPointer<T>& B)
	{
		return A.obj_ > B.obj_;
	}
